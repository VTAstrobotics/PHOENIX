...
const int HALLPIN11 = 2;
const int HALLPIN21 = 3; 
int steps1 = 0;
int steps2 = 0;
int pos1 = 0;
int pos2 = 0;
const int actuator11 = 7;
const int actuator12 = 6;
//TODO: set these to actual values;
const int actuator21 = 5;
const int actuator22 = 4;
...
void setup()
{
  ...
  pinMode (10, OUTPUT);  // PWM master
  pinMode (9, OUTPUT);  // PWM child
  ...
  analogWrite(10, 150);  //speed of master
  Output = 0;
...
void loop()
{
  ...
  analogWrite(9, childSpeed); //speed of child
  moveActuator1(1);
  }
