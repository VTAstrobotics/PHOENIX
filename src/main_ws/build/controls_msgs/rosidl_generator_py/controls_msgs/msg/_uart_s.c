...
bool controls_msgs__msg__uart__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("controls_msgs.msg._uart.Uart", full_classname_dest, 28) == 0);
  }
  controls_msgs__msg__Uart * ros_message = _ros_message;
  {  // msg
...
PyObject * controls_msgs__msg__uart__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("controls_msgs.msg._uart");
