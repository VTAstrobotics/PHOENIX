...
static const _Uart_type_support_symbol_names_t _Uart_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controls_msgs, msg, Uart)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controls_msgs, msg, Uart)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, controls_msgs, msg, Uart)() {
  return &::controls_msgs::msg::rosidl_typesupport_c::Uart_message_type_support_handle;
}
