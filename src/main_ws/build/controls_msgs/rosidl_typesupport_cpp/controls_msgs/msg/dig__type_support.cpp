...
static const _Dig_type_support_symbol_names_t _Dig_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controls_msgs, msg, Dig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, controls_msgs, msg, Dig)),
  }
};
...
{
  return &::controls_msgs::msg::rosidl_typesupport_cpp::Dig_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, controls_msgs, msg, Dig)() {
  return get_message_type_support_handle<controls_msgs::msg::Dig>();
}
