...
static const _Uart_type_support_symbol_names_t _Uart_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controls_msgs, msg, Uart)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, controls_msgs, msg, Uart)),
  }
};
...
{
  return &::controls_msgs::msg::rosidl_typesupport_cpp::Uart_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, controls_msgs, msg, Uart)() {
  return get_message_type_support_handle<controls_msgs::msg::Uart>();
}
