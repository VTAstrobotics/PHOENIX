...
: ${AMENT_CURRENT_PREFIX:="/workspaces/PHOENIX/src/main_ws/src/install/drive_station"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/drive_station/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/drive_station/environment/path.sh"
