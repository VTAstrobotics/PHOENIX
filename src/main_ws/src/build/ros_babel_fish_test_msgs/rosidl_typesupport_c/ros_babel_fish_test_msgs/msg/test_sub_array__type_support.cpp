...
static const _TestSubArray_type_support_symbol_names_t _TestSubArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_babel_fish_test_msgs, msg, TestSubArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_babel_fish_test_msgs, msg, TestSubArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_babel_fish_test_msgs, msg, TestSubArray)() {
  return &::ros_babel_fish_test_msgs::msg::rosidl_typesupport_c::TestSubArray_message_type_support_handle;
}
