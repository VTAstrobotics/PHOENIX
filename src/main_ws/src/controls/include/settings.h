...
#define CTRL_EXTEND_BUCKET BUTTON_DPAD_UP
#define CTRL_RETRACT_BUCKET BUTTON_DPAD_DOWN

#define CTRL_EXTEND_SCOOP BUTTON_DPAD_RIGHT
#define CTRL_RETRACT_SCOOP BUTTON_DPAD_LEFT
