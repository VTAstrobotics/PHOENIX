...
#ifndef ROS_BABEL_FISH_TEST_MSGS__MSG__DETAIL__TEST_MESSAGE__FUNCTIONS_H_
#define ROS_BABEL_FISH_TEST_MSGS__MSG__DETAIL__TEST_MESSAGE__FUNCTIONS_H_
 ...
 * calls
 * ros_babel_fish_test_msgs__msg__TestMessage__init().
...
/**
 * It calls
 * ros_babel_fish_test_msgs__msg__TestMessage__fini()
 ...
 * ros_babel_fish_test_msgs__msg__TestMessage__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ros_babel_fish_test_msgs__msg__TestMessage__Sequence__fini()
 * on the array,
...
#endif  // ROS_BABEL_FISH_TEST_MSGS__MSG__DETAIL__TEST_MESSAGE__FUNCTIONS_H_
